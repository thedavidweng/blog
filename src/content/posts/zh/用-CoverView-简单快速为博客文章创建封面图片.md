...
![](/posts/用 CoverView 简单快速为博客文章创建封面图片/cover.avif)
## 前言
...
![](/posts/用 CoverView 简单快速为博客文章创建封面图片/Untitled.avif)
...
![](/posts/用 CoverView 简单快速为博客文章创建封面图片/Untitled 1.avif)
接下来的介绍我会直接使用汉化版的截图。

## 选项

![](/posts/用 CoverView 简单快速为博客文章创建封面图片/Untitled 2.avif)
**CoverView** 目前只提供三种字体样式，未来有改进空间。

![](/posts/用 CoverView 简单快速为博客文章创建封面图片/SCR-20220506-pjp.avif)
颜色方面提供十六进制颜色代码，RGB 数值，取色器和色盘多种交互方式，非常完善。

![](/posts/用 CoverView 简单快速为博客文章创建封面图片/Untitled 3.avif)
![](/posts/用 CoverView 简单快速为博客文章创建封面图片/Untitled 4.avif)
样式方面提供了四种主题（标题排列方式）和十九种不同的背景图案。

![](/posts/用 CoverView 简单快速为博客文章创建封面图片/Untitled 5.avif)
...
![](/posts/用 CoverView 简单快速为博客文章创建封面图片/Untitled 6.avif)