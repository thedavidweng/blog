...
![阿里云盘桌面端下载页](/posts/aliyun-drive-desktop-beta/alidrive-desktop-client.avif)
...
![macOS 版安装包](/posts/aliyun-drive-desktop-beta/alidrive-desktop-macos-install.avif)


![登录界面](/posts/aliyun-drive-desktop-beta/alidrive-desktop-macos-login.avif)


![桌面端主界面](/posts/aliyun-drive-desktop-beta/alidrive-desktop-macos-ui.avif)


测试版客户端提供的功能与网页端相同，推测是使用 **Electron** 制作的客户端。

![设置页](/posts/aliyun-drive-desktop-beta/alidrive-desktop-macos-settings.avif)
