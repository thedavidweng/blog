...
- Download and install [SafePal App 1.1](https://safepal.com/en/download), create a new wallet.
...
- Activate wallet: [How to Activate the SafePal X1 Hardware Wallet – SafePal Help Center](https://safepalsupport.zendesk.com/hc/en-us/articles/17179100207899)

- Create new wallet in hardware wallet: [How to Create Wallet in SafePal X1 Hardware Wallet – SafePal Help Center](https://safepalsupport.zendesk.com/hc/en-us/articles/18553611052827)

- Pair hardware wallet with SafePal App: [X1 User Manual – SafePal Help Center](https://safepalsupport.zendesk.com/hc/en-us/articles/18121204766491)

- Add USDC (Polygon) to hardware wallet asset list: [How to add $USDC(Polygon) to SafePal X1 Wallet Assest List – SafePal Help Center](https://safepalsupport.zendesk.com/hc/en-us/articles/22182713414299)
...
2. Which blockchains currently supports Native USDC?

Avalanche, Arbitrum, Ethereum, Solana, and more

3. What are the benefits of USDC?

A faster, safer, and more efficient way to send, spend, and exchange money.

4. What is the advantage of using USDC over traditional fiat currency?

All of the above

5. What does the term "always-on digital dollars" mean in relation to USDC?
