...
FSNote是一款支持 macOS 和 iOS 的开源笔记软件。 官方列出了以下主要特点
...
![](/posts/Apple-生态下的开源笔记---FSNotes/macOS-and-iOS.avif)
...
![](/posts/Apple-生态下的开源笔记---FSNotes/Built-in tutorial.avif)
笔者对其进行了翻译，并且在 GitHub 提交了希望增加多语言支持的 Issues。

![](/posts/Apple-生态下的开源笔记---FSNotes/GitHub Issue.avif)
接下来是本人翻译的使用教学。
...
![](/posts/Apple-生态下的开源笔记---FSNotes/view-options.avif)
View

您可以配置排序、方向、可见性设置。

![](/posts/Apple-生态下的开源笔记---FSNotes/preferences.avif)
Preference
...
![](/posts/Apple-生态下的开源笔记---FSNotes/tag-autocomplete.avif)
Hello
...
![](/posts/Apple-生态下的开源笔记---FSNotes/git-save.avif)
### 6. Mermaid 与 MathJax
...
![](/posts/Apple-生态下的开源笔记---FSNotes/git-commit-dialog.avif)
Save

并在菜单栏恢复到历史版本：

![](/posts/Apple-生态下的开源笔记---FSNotes/git-history.avif)
History
...
![](/posts/Apple-生态下的开源笔记---FSNotes/backup-settings.avif)
Backup
...
![](/posts/Apple-生态下的开源笔记---FSNotes/backup-backup.avif)
BackupBackup
...
![](/posts/Apple-生态下的开源笔记---FSNotes/image-toolbar.avif)
icon
...
以上是 FSNotes 的使用教程，这篇教程将 FSNotes 的常用使用场景基本表现了出来，作为一款以 Markdown 为主的笔记软件，其优缺点都十分明显。 对于已经有 Markdown 使用经验的朋友，应该已经有了一套自己管理`.md`文件的工作流。但对于新手，通过一个更加类似传统笔记软件（Evernote，OneNote）的笔记软件来熟悉 Markdown 的使用可以是个非常友好的入门选择。