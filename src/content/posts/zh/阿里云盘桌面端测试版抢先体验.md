...
![](/posts/aliyun-drive-desktop-beta/Alidrive-client.avif)
Alidrive-client
...
![](/posts/aliyun-drive-desktop-beta/Alidrive-macOS -install.avif)
Alidrive-macOS-install

![](/posts/aliyun-drive-desktop-beta/Alidrive-macOS -login.avif)
Alidrive-macOS-login

![](/posts/aliyun-drive-desktop-beta/Alidrive-macOS -ui.avif)
Alidrive-macOS-ui

测试版客户端提供的功能与网页端相同，推测是使用 **Electron** 制作的客户端。

![](/posts/aliyun-drive-desktop-beta/Alidrive-macOS - setting.avif)
